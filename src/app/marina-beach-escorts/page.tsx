...
const areaSlug = "marina-beach-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Chennai Marina Beach service area configuration missing");
}
...
export default function MarinaBeachEscortsPage() {
