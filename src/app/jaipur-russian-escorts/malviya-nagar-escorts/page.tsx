...
const areaSlug = "malviya-nagar-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Jaipur Malviya Nagar service area configuration missing");
}
...
export default function MalviyaNagarEscortsPage() {
