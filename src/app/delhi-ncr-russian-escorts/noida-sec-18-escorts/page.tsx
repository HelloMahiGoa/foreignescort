...
const areaSlug = "noida-sec-18-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Delhi NCR Noida Sector 18 service area configuration missing");
}
...
export default function NoidaSec18EscortsPage() {
