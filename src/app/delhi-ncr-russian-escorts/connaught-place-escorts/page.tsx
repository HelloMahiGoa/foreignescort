...
const areaSlug = "connaught-place-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Delhi NCR Connaught Place service area configuration missing");
}
...
export default function ConnaughtPlaceEscortsPage() {
