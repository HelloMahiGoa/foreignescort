...
const areaSlug = "vasant-kunj-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Delhi NCR Vasant Kunj service area configuration missing");
}
...
export default function VasantKunjEscortsPage() {
