          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="group relative overflow-hidden rounded-2xl border border-white/15 bg-black/55 p-5 shadow-[0_25px_70px_-45px_rgba(0,0,0,0.85)] transition duration-500 hover:border-[#60a5fa]/60">
              ...
              <div className="relative">
                <p className="text-lg font-semibold text-white">Service Nature</p>
                <p className="mt-2 text-sm text-white/70">
                  We provide professional companionship coordination services for adults.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/15 bg-black/55 p-5 shadow-[0_25px_70px_-45px_rgba(0,0,0,0.85)] transition duration-500 hover:border-[#60a5fa]/60">
              <div className="pointer-events-none absolute inset-0 opacity-0 blur-2xl transition duration-500 group-hover:opacity-40 bg-gradient-to-br from-blue-500/90 via-cyan-400/80 to-teal-500/90" aria-hidden="true" />
              <div className="relative">
                <p className="text-lg font-semibold text-white">Legal Compliance</p>
                <p className="mt-2 text-sm text-white/70">
                  All services comply with applicable local laws and regulations.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-black/50 p-6 backdrop-blur-lg shadow-[0_30px_70px_-45px_rgba(0,0,0,0.8)]">
            ...
            <div className="mt-4 space-y-3 text-sm text-white/75">
              {[
                { label: "Service Scope", step: "01" },
                { label: "Legal Notice", step: "02" },
                { label: "User Responsibility", step: "03" },
              ].map((item) => (
                <div
                  key={item.step}
      ...
      <section className="relative bg-zinc-950 py-8 lg:py-12">
        <div className="mx-auto w-full max-w-6xl px-6">
          <div className="space-y-8">
            ...
            <div className="rounded-3xl border border-white/15 bg-black/50 p-8 backdrop-blur-lg shadow-[0_35px_80px_-50px_rgba(0,0,0,0.8)]">
              <h2 className="text-2xl font-semibold mb-6 text-white">User Responsibility</h2>
              <div className="space-y-4 text-base leading-relaxed text-white/80">
                <p>
                  Users of our services are responsible for their own actions and compliance with applicable laws. Clients must be of legal age (18+) and must provide accurate information when booking.
                </p>
                <p>
                  Clients are expected to treat all <strong>Russian escorts</strong> with respect and maintain professional boundaries. Any behavior that violates these standards may result in immediate termination of service.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/15 bg-black/50 p-8 backdrop-blur-lg shadow-[0_35px_80px_-50px_rgba(0,0,0,0.8)]">
              ...
              <div className="space-y-4 text-base leading-relaxed text-white/80">
                <p>
                  For questions about this disclaimer or our services, contact our operations desk at <Link href="tel:+918121426651" className="text-amber-400 hover:text-amber-300 underline">+91 81214 26651</Link> or use our <Link href="/contact" className="text-amber-400 hover:text-amber-300 underline">contact form</Link>.
                </p>
                <p>
                  This disclaimer may be updated from time to time. Continued use of our services constitutes acceptance of any updates to this disclaimer.
                </p>
              </div>
            </div>
          </div>
