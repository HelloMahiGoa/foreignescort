...
const areaSlug = "jubilee-hills-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Hyderabad Jubilee Hills service area configuration missing");
}
...
export default function JubileeHillsEscortsPage() {
