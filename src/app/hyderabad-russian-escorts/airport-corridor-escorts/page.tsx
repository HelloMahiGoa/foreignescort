...
const areaSlug = "airport-corridor-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Hyderabad Airport Corridor service area configuration missing");
}
...
export default function AirportCorridorEscortsPage() {
