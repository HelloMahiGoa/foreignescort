...
const areaSlug = "koramangala-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Bangalore Koramangala service area configuration missing");
}
...
export default function KoramangalaEscortsPage() {
