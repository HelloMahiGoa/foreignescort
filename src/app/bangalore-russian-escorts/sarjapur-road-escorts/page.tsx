...
const areaSlug = "sarjapur-road-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Bangalore Sarjapur Road service area configuration missing");
}
...
export default function SarjapurRoadEscortsPage() {
