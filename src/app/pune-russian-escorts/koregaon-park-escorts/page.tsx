...
const areaSlug = "koregaon-park-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Pune Koregaon Park service area configuration missing");
}
...
export default function KoregaonParkEscortsPage() {
