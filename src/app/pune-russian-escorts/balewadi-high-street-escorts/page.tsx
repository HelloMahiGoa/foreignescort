...
const areaSlug = "balewadi-high-street-escorts";

const city = getCityBySlug(citySlug);
const area = getServiceAreaBySlug(citySlug, areaSlug);

if (!city || !area) {
  throw new Error("Pune Balewadi High Street service area configuration missing");
}
...
export default function BalewadiHighStreetEscortsPage() {
