# Website Build Prompt: Mahi Escorts Goa

## Project Overview
Create a complete, production-ready website for **Mahi Escorts** (https://mahiescorts.in) targeting Goa, India. The website should replicate the exact design, layout, structure, and functionality of the existing Hello Mahi website, but customized for Goa with the Mahi Escorts branding.
...
### Domain & Branding
- **Domain**: https://mahiescorts.in
- **Brand Name**: Mahi Escorts
- **Location**: Goa, India
...
```typescript
{
  ...
  metadataBase: new URL("https://mahiescorts.in"),
  openGraph: {
    title: "Goa Russian Escorts | Book Russian Girls With 10% Discount",
    description: "...",
    url: "https://mahiescorts.in",
    siteName: "Mahi Escorts",
  ...
  alternates: {
    canonical: "https://mahiescorts.in",
  },
  other: {
    "geo.region": "IN-GA",
    "geo.placename": "Goa",
...
- Update all contact information and branding to "Mahi Escorts"
...
8. Deployed to mahiescorts.in domain

---

**This prompt provides a complete blueprint for building the Mahi Escorts Goa website with the exact same design and functionality as the Hello Mahi website, customized for Goa.**
